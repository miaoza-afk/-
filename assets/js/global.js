document.addEventListener("DOMContentLoaded", function () {
  ...
  const parameterContents = {
    ...
    "single-trait-evaluation": document.getElementById(
      "single-trait-evaluation-content",
    ),
    "pedigree-qc": document.getElementById("pedigree-qc-content"),
    "pedigree-sorting": document.getElementById("pedigree-sorting-content"),
    "relationship-matrix": document.getElementById(
      "relationship-matrix-content",
    ),
    "xp-plink-filter": document.getElementById("xp-plink-filter-content"),
    "xxt-histogram": document.getElementById("xxt-histogram-content"),
    "sdt-histogram": document.getElementById("sdt-histogram-content"),
  };
  ...
  const toolNames = {
    ...
    "single-trait-evaluation": "遗传评估-单性状模型-全流程自动化分析",
    histogram: "直方图绘制",
    "pedigree-qc": "系谱处理-系谱质控",
    "pedigree-sorting": "系谱处理-系谱个体排序",
    "relationship-matrix": "系谱处理-亲缘关系矩阵构建",
    "xp-plink-filter": "芯片数据处理-plink过滤",
    "xxt-histogram": "箱线图绘制",
    "sdt-histogram": "散点图绘制",
  };
  ...
  //定义title-system点击事件
  document.getElementById("title-system").addEventListener("click", showHome);

  //显示首页
  function showHome() {
    //显示首页
    document.getElementById("home-workspace").classList.remove("hidden");
    //隐藏中央区和历史记录
    document.getElementById("central-workspace").classList.add("hidden");
  ...
  function showParameterContent(toolId) {
    //隐藏首页
    document.getElementById("home-workspace").classList.add("hidden");
    //显示中央区和历史记录
    document.getElementById("central-workspace").classList.remove("hidden");
    document.getElementById("history-workspace").classList.remove("hidden");
